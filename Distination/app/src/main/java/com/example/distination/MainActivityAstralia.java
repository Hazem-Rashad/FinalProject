...
public class MainActivityAstralia extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_astralia);
        ArrayList<Countries> countries = new ArrayList<>();
        ListView listView1 = findViewById(R.id.listeviweastralia);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case  R.id.homeId:
                        Intent intent = new Intent(MainActivityAstralia.this , MainActivityMain.class);
                    ...
                    case  R.id.backId:
                        Intent back = new Intent(MainActivityAstralia.this , MainActivityQ.class);
                        startActivity(back);
                        overridePendingTransition(0,0);
                        return true;
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent detailsIntent = new Intent(MainActivityAstralia.this , DetailActivity.class);
